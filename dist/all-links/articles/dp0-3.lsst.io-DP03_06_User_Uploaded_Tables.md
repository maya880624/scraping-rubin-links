05. Using user-supplied catalogs in DP0.3 (beginner) — Rubin Observatory DP0.3
...
1.3.
Download the file to your computer using the link to file in GitHub containing the catalog.
