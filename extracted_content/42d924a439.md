...
DP03_06_Using_User-Supplied_Catalogs.ipynb
...
**Level:** Beginner   
**Description:** Demonstrate the TAP upload functionality for user-supplied tables and their use in queries for DP0.3.   
**Skills:** Use the TAP service to access the DP0.3 tables, Upload user-supplied tables and retreived tables from the Gaia ESA Archive center using the TAP upload feature, Use them in queries.   
**Data Products:** DP0.3 catalogs SSObject, DiaSource, and MPCORB (10-year catalogs).   
**Packages:** lsst.rsp.get_tap_service   
